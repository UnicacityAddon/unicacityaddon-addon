        ...
        if (ConfigElements.getServiceMessagesActivated()) {
            if (m.find()) {
                ...
                e.setMessage(Message.getBuilder().of("Neuer Notruf").color(ColorCode.RED).advance().space()
                        ...
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space() // Notruf Sender
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(3)).color(ColorCode.AQUA).bold().hoverEvent(HoverEvent.Action.SHOW_TEXT, hoverMessage) // Grund
            ...
            if (m.find()) {
                ...
                e.setMessage(Message.getBuilder().of("Neu geöffnet").color(ColorCode.RED).advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space() // Öffner
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(2)).color(ColorCode.AQUA).bold().hoverEvent(HoverEvent.Action.SHOW_TEXT, hoverMessage) // Notruf sender
                        .clickEvent(ClickEvent.Action.RUN_COMMAND, "/acceptservice " + m.group(1).replace("[UC]", ""))
                        .advance().createComponent());
                return false;
            }
            ...
            if (m.find()) {
                e.setMessage(Message.getBuilder().of("➥").color(ColorCode.DARK_GRAY).advance().space()
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().createComponent());
                return false;
            }
            ...
            if (m.find()) { // Eine näheste Person
                if (m.group(2).replace("[UC]", "").equals(AbstractionLayer.getPlayer().getName()))
                    e.setMessage(Message.getBuilder().of("➥").color(ColorCode.DARK_GRAY).advance().space()
                            .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space()
                            .of("-").color(ColorCode.GRAY).advance().space()
                            .of("Ja " + m.group(3)).color(ColorCode.AQUA).bold().advance().createComponent());
                else
                    e.setMessage(Message.getBuilder().of("➥").color(ColorCode.DARK_GRAY).advance().space()
                            .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space()
                            .of("-").color(ColorCode.GRAY).advance().space()
                            .of("Nein").color(ColorCode.AQUA).bold().hoverEvent(HoverEvent.Action.SHOW_TEXT,
                                    Message.getBuilder().of("➥" + m.group(2) + m.group(3)).color(ColorCode.AQUA).bold().advance().createComponent())
                            .advance().createComponent());
                return false;
            }
            ...
            if (m.find()) {
                if (m.group(2).replace("[UC]", "").equals(AbstractionLayer.getPlayer().getName())) {
                    e.setMessage(Message.getBuilder().of("➥").color(ColorCode.DARK_GRAY).advance().space()
                            .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space()
                            .of("-").color(ColorCode.GRAY).advance().space()
                            .of("Ja " + m.group(3)).color(ColorCode.AQUA).bold().hoverEvent(HoverEvent.Action.SHOW_TEXT,
                                    Message.getBuilder().of("➥" + m.group(2) + m.group(3)).color(ColorCode.AQUA).bold().advance().newline()
                                            .of("➥" + m.group(5) + m.group(6)).color(ColorCode.AQUA).bold().advance().createComponent())
                            .advance().createComponent());
                    return false;
                    ...
                    e.setMessage(Message.getBuilder().of("➥").color(ColorCode.DARK_GRAY).advance().space()
                            .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space()
                            .of("-").color(ColorCode.GRAY).advance().space()
                            .of("Vlt " + m.group(3) + " (" + m.group(6) + ")").color(ColorCode.AQUA).bold().hoverEvent(HoverEvent.Action.SHOW_TEXT,
                                    Message.getBuilder().of("➥" + m.group(2) + " " + m.group(3)).color(ColorCode.AQUA).bold().advance().newline()
                                            .of("➥" + m.group(5) + " " + m.group(6)).color(ColorCode.AQUA).bold().advance().createComponent())
                            .advance().createComponent());
                    return false;
            ...
            if (m.find()) {
                e.setMessage(Message.getBuilder().of("Angenommen").color(ColorCode.GREEN).advance().space()
                        ...
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(2)).color(ColorCode.AQUA).bold().advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(3) + "m").color(ColorCode.AQUA).bold().advance().createComponent());
                return false;
            }
            ...
            if (m.find()) {
                e.setMessage(Message.getBuilder().of("Gelöscht").color(ColorCode.RED).advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(2)).color(ColorCode.AQUA).bold().advance().space() // Löscher
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().createComponent()); // Service sender
                return false;
            }
            ...
            if (m.find()) {
                e.setMessage(Message.getBuilder().of("Blockiert").color(ColorCode.RED).advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(2)).color(ColorCode.AQUA).bold().advance().space() // Blockierer
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().createComponent()); // Blockierter
                return false;
            }
            ...
            if (m.find()) {
                e.setMessage(Message.getBuilder().of("Entblockt").color(ColorCode.GREEN).advance().space()
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(2)).color(ColorCode.AQUA).bold().advance().space() // Entblocker
                        .of("-").color(ColorCode.GRAY).advance().space()
                        .of(m.group(1)).color(ColorCode.AQUA).bold().advance().createComponent()); // Blockierter
                return false;
            }
