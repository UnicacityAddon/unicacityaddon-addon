...
public class ConfigSubSettings {
    ...
    static Settings getNameTagFactionSubSettings() {
        ...
        nameTagFactionDropDownMenu0.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(ColorCode.valueOf(object.toString().toUpperCase()).toString(), x, y));
    ...
    static Settings getNameTagAllianceSubSettings() {
        ...
        nameTagAllianceDropDownMenu0.setEntryDrawer((object, x, y, string) ->  UnicacityAddon.LABYMOD.getDrawUtils().drawString(ColorCode.valueOf(object.toString().toUpperCase()).toString(), x, y));
        ...
        nameTagAllianceDropDownMenu1.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(Faction.valueOf(object.toString().toUpperCase()).getDisplayName(), x, y));
        ...
        nameTagAllianceDropDownMenu2.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(Faction.valueOf(object.toString().toUpperCase()).getDisplayName(), x, y));
    ...
    static Settings getNameTagStreetwarSubSettings() {
        ...
        nameTagStreetwarDropDownMenu0.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(ColorCode.valueOf(object.toString().toUpperCase()).toString(), x, y));
        ...
        nameTagStreetwarDropDownMenu1.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(Faction.valueOf(object.toString().toUpperCase()).getDisplayName(), x, y));
        ...
        nameTagStreetwarDropDownMenu2.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(Faction.valueOf(object.toString().toUpperCase()).getDisplayName(), x, y));
    ...
    static Settings getEigenbedarfCocaineSettings(UnicacityAddon unicacityAddon) {
        ...
        cocainPurity.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(DrugPurity.valueOf(object.toString().toUpperCase()).getPurityString(), x, y));
    ...
    static Settings getEigenbedarfWeedSettings(UnicacityAddon unicacityAddon) {
        ...
        weedPurity.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(DrugPurity.valueOf(object.toString().toUpperCase()).getPurityString(), x, y));
    ...
    static Settings getEigenbedarfMethSettings(UnicacityAddon unicacityAddon) {
        ...
        methPurity.setEntryDrawer((object, x, y, string) -> UnicacityAddon.LABYMOD.getDrawUtils().drawString(DrugPurity.valueOf(object.toString().toUpperCase()).getPurityString(), x, y));
