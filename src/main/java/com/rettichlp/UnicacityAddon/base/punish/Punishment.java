...
public enum Punishment {
    ...
    METAGAMING_SECOND_VIOLATION("Metagaming-(zweites-Vergehen)","Metagaming", 400, 360, 0, false, false, 0, 0),
    ...
    SDM_SECOND_VIOLATION("Sinnloses-Deathmatch-(zweites-Vergehen)","Sinnloses Deathmatch", 300, 0, 0, false, false, 14, 0),
    ...
    BAD_GOV_SECOND_VIOLATION("Bad-/gov-(zweites-Vergehen)","Bad /gov", 300, 120, 0, false, false, 0, 0),
    BAD_NEWS_FIRST_VIOLATION("Bad-/news-(erstes-Vergehen)","Bad /news", 300, 0, 0, false, false, 0, 0),
    BAD_NEWS_SECOND_VIOLATION("Bad-/news-(zweites-Vergehen)","Bad /news", 300, 120, 0, false, false, 0, 0),
    BAD_MEGAPHONE_FIRST_VIOLATION("Bad-/megaphon-(erstes-Vergehen)","Bad /megaphon (erstes Vergehen)", 300, 0, 0, false, false, 0, 0),
    BAD_MEGAPHONE_SECOND_VIOLATION("Bad-/megaphon-(zweites-Vergehen)","Bad /megaphon", 300, 120, 0, false, false, 0, 0),
    ...
    BAD_ROLEPLAY_SECOND_VIOLATION("Bad-Roleplay-(zweites-Vergehen)","Bad Roleplay", 400, 360, 0, false, false, 0, 0),
