...
public enum Punishment {
    ...
    CHEATEN_UNDER_LEVEL5("Cheaten (unter Level 5)", 0, -1, 0, false, 0),
    CHEATEN_OVER_LEVEL_5("Cheaten (über Level 5)", 0, 10080, 1, false, 0),
    EXCESSIVE_USE_OF_CONTRACT("Exzessives Setzen", 0, 2880, 0, false, 0),
    THIRD_PARTY_ADVERTISING_UNDER_LEVEL5("Fremdwerbung (unter Level 5)", 0, 43200, 1, false, 0),
    THIRD_PARTY_ADVERTISING_OVER_LEVEL5("Fremdwerbung (über Level 5)", 0, 10080, 1, false, 0),
