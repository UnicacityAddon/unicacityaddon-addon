...
public class FDSFChatListener {
    ...
    public void onChatMessageSend(ChatMessageSendEvent e) {
        ...
        if (msg.startsWith("/f ") && !MobileListener.hasCommunications && this.unicacityAddon.services().utilService().isUnicacity()) {
            ...
            e.setCancelled(true);
        } else if (msg.startsWith("/d ") && !MobileListener.hasCommunications && this.unicacityAddon.services().utilService().isUnicacity()) {
            p.sendErrorMessage("Du hast keine Kommunikationsmittel!");
            ...
            e.setCancelled(true);
        } else if (msg.startsWith("/sf ") && !MobileListener.hasCommunications && this.unicacityAddon.services().utilService().isUnicacity()) {
            p.sendErrorMessage("Du hast keine Kommunikationsmittel!");
