...
public class ChatLogReceiveChatListener {
    ...
    public void onChatReceive(ChatReceiveEvent e) {
        ...
        if (this.unicacityAddon.utils().isUnicacity() && !PatternHandler.BLACKLIST_LIST_PATTERN.matcher(msg).find() && !PatternHandler.CONTRACT_LIST_PATTERN.matcher(msg).find() && !PatternHandler.WANTED_LIST_PATTERN.matcher(msg).find())
