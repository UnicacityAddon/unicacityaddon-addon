...
public class PatternHandler {
    ...
    public static final Pattern BANK_ROB_ENDED_PATTERN = Pattern.compile("^HQ: Der Staatsbankraub wurde erfolgreich verhindert!$|^HQ: Der Staatsbankraub konnte nicht verhindert werden!$|^\\[Bankraub] Der Bankraub war (nicht erfolgreich|erfolgreich)!$");
