...
import com.rettichlp.unicacityaddon.gangzone.GangzoneService;
...
@Singleton
@Implements(GangzoneService.class)
public class DefaultGangzoneService implements GangzoneService {

    private final WorldObjectRegistry worldObjectRegistry;

    private final Collection<Gangzone> gangzones;

    private UnicacityAddon unicacityAddon;

    public DefaultGangzoneService() {
        this.worldObjectRegistry = Laby.references().worldObjectRegistry();

        this.gangzones = new ArrayList<>();
    }

    public void load(UnicacityAddon unicacityAddon) {
        this.unicacityAddon = unicacityAddon;

        for (Gangzone gangzone : this.getAllGangzones()) {
            this.gangzones.add(gangzone);
            this.worldObjectRegistry.register(gangzone);
        }
    }

    @Override
    public Collection<Gangzone> getAllGangzones() {
        return List.of(
                new DefaultGangzone(Faction.CALDERON.getColor().getColor(), List.of(
                ...
                new DefaultGangzone(Faction.LACOSANOSTRA.getColor().getColor(), List.of(
                ...
                new DefaultGangzone(Faction.LEMILIEU.getColor().getColor(), List.of(
                ...
                new DefaultGangzone(Faction.OBRIEN.getColor().getColor(), List.of(
                ...
                new DefaultGangzone(Faction.WESTSIDEBALLAS.getColor().getColor(), List.of(
                ...
                new DefaultGangzone(Faction.KERZAKOV.getColor().getColor(), List.of(
                ...
                // attackable: ALTSTADT
                new DefaultGangzone(Faction.NULL.getColor().getColor(), List.of(
