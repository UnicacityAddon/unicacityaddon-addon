...
public class ImageUploadUtils {
    ...
    public String uploadToLink(File file) {
    ...
    private String toBase64(File file) throws IOException {
        ...
        return URLEncoder.encode(new String(encoded, StandardCharsets.US_ASCII), StandardCharsets.UTF_8);
    }
    ...
    private void writeToConnection(HttpURLConnection conn, String message) throws IOException {
