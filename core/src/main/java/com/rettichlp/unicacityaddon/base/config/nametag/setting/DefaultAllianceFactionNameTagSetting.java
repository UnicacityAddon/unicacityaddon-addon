...
public class DefaultAllianceFactionNameTagSetting extends Config implements AllianceFactionNameTagSetting {
    ...
    @DropdownSetting
    private final ConfigProperty<ColorCode> color = ConfigProperty.createEnum(ColorCode.DARK_PURPLE);
