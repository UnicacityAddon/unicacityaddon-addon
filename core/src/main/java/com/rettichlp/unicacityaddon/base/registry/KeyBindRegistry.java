...
public class KeyBindRegistry {
    ...
    public static KeyBinding damageIndicator;
    ...
    public static void registerKeyBinds() {
        ...
        int hotkeyDamageIndicator = config.has("HOTKEY_DAMAGE") ? config.get("HOTKEY_DAMAGE").getAsInt() : Keyboard.KEY_NONE;
        ...
        damageIndicator = new KeyBinding("Damage indicator", hotkeyDamageIndicator, KEY_CATEGORY);
        ...
        ClientRegistry.registerKeyBinding(damageIndicator);
        executed = true;
    }
