...
public class DutyTag extends NameTag {
    ...
    protected @Nullable RenderableComponent getRenderableComponent() {
        ...
        boolean isEnabled = unicacityAddonConfiguration.enabled().get() && unicacityAddonConfiguration.nameTagSetting().duty().get();
    ...
    private RenderableComponent getComponent(String playerName) {
        ...
        return this.unicacityAddon.services().factionService().checkPlayerDuty(playerName) ? RenderableComponent.of(component) : null;
    }
}