...
volt {
    ...
    packageName("com.rettichlp.unicacityaddon.v1_19.mixins")

    //Use this if you want to inherit the mixins from your 1.18 implementation
    //packageName("com.rettichlp.unicacityaddon.v1_18.mixins")
    //inheritFrom("v1_18")

    //Use this if you want to inherit the mixins from your 1.17 implementation
    //packageName("com.rettichlp.unicacityaddon.v1_17.mixins")
    //inheritFrom("v1_17")
...
//    java {
//        exclude("com.rettichlp.unicacityaddon.v1_17.mixins.ExampleMixin")
//    }
//}
...
//    java {
//        exclude("com.rettichlp.unicacityaddon.v1_18.mixins.ExampleMixin")
//    }
//}
//
...
intellij {
    ...
    //renameApiMixin {
    //    relocate("com.rettichlp.unicacityaddon.v1_17.", "com.rettichlp.unicacityaddon.v1_19.")
    //    relocate("com.rettichlp.unicacityaddon.v1_18.", "com.rettichlp.unicacityaddon.v1_19.")
    //}
